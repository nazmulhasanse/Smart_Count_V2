...
<div class="row">
    ...
    <div class="col-2">
        <b>Month: </b><?php echo $month; ?></br>

    </div>
    <div class="col-2">

        <b>Line: </b><?php echo $_GET['Line']; ?></br>
...
//     $sql2 = "SELECT 
//     SUM(StepTimeMins) AS SMV
//     FROM
//     `ework_sales_order`
//     WHERE
//     docnumber = '$docnumber' LIMIT 1";
...
$sql = "SELECT
    DATE_FORMAT(date, '%Y-%m-%d') AS DayOfMonth,
    SUM(quantity) AS DailyProductionQty
FROM
    eworker_bulk_operation
WHERE
    DATE_FORMAT(date, '%Y-%m') = '$month' AND line = '$Line'
GROUP BY
    DayOfMonth
ORDER BY
    DayOfMonth ASC;";
