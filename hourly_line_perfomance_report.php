...
<body class="hold-transition sidebar-mini">
   <div class="wrapper">
      ...
      <header style="text-align: center;">
           <h1>Hourly Line Performance Report</h1>
      </header>
                              ...
                              <table class="table table-bordered" id="myDataTable">
                                 ...
                                 <tbody>
                                    ...
                                    <tr data-id="1" class="valid new">
                                       <?php
                                          echo '<td><a target="_blank" href="hourly_line_board.php?Date=' . urlencode($row['date']) . '&Line=' . urlencode($row['line'])  . '&cardnumber=' . urlencode($row['cardnumber']) . '&name=' . urlencode($row['name']) .'">' . htmlspecialchars($row['date']) . '</a></td>';
