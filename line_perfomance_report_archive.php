<?php
   ...
   $sql = "SELECT
       ...
       FROM
         ...
         LEFT JOIN `ework_target_efficiency` `te` ON `wp`.`docnumber` = `te`.`Docnumber` AND SUBSTRING(`wp`.`DateTime`, 1, 10) = SUBSTRING(`te`.`Date`, 1, 10)
