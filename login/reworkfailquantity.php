            ...
            function updateDisplay() {
                ...
                dataArray.forEach(function(value) {
                    ...
                    row.innerHTML =
                        ...
                        "<td><a href='#' class='btn btn-danger btn-sm' onclick='removeValue(this)'><i style='color: red;font-size: 20px;'></i>Delete</a></td>";
            ...
            <div class="select-container">
                <table id="addValueTable" class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="delete-btn" onclick="removeValue(this)">
                                <i style="color: red; font-size: 20px;" class="fa fa-trash-o"></i>
                                Delete
                            </a>
                        </td>
