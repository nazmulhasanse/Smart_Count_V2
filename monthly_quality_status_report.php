...
<body class="hold-transition sidebar-mini">
   <div class="wrapper">
      ...
      <header style="text-align: center;">
           <h1>Monthly Quality Status Report</h1>
      </header>
                              ...
                              <table class="table table-bordered" id="myDataTable">
                                 ...
                                 <tbody>
                                    ...
                                    <tr data-id="1" class="valid new">
                                       <?php
                                          echo '<td><a target="_blank" href="monthly_quality_status_pie_chart.php?Date=' . urlencode($row['DateTime']) . '&Site=' . urlencode($row['site']) . '&Building=' . urlencode($row['building']) . '&Floor=' . urlencode($row['floor']) . '&Line=' . urlencode($row['SewingLine']) . '&WorkOrder=' . urlencode($row['WorkOrder']) . '&Customer=' . urlencode($row['Customer']) . '&Style=' . urlencode($row['Style']) . '&StyleDescription=' . urlencode($row['StyleDescription']) . '">' . htmlspecialchars($row['DateTime']) . '</a></td>';
