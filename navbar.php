<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
        // Wait for the DOM to be fully loaded, then trigger the click event
        var pushmenuButton = document.getElementById("pushmenu");
        if (pushmenuButton) {
            pushmenuButton.click(); // Trigger the click event
        }
    });
</script>